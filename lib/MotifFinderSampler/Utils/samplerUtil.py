...
class samplerUtil:
  ...
  def build_sampler_command(self, inputFilePath, motiflen, prb,config):
      cmd1 = 'cp -r /kb/module/deps/kb_sampler/CreateBackgroundModel /kb/module/work/tmp/'
      cmd2 = 'cp -r /kb/module/deps/kb_sampler/MotifSampler /kb/module/work/tmp/'
