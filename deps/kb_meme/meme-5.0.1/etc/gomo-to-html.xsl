...
-->
  ...
  <xsl:include href="constants.js.xsl"/>
  <xsl:include href="utilities.js.xsl"/>
  <xsl:include href="simple-shared-doc.js.xsl" />
  ...
  <xsl:template name="html-js">
    <script type="text/javascript">
      <xsl:call-template name="constants.js" />
      <xsl:call-template name="utilities.js" />
      <xsl:call-template name="simple-shared-doc.js" />
    </script>
  </xsl:template>

  <xsl:template name="help-popups">
    <div class="pop_content" id="pop_results_tsv">
      <script>print_doc("pop_results_tsv", "gomo-results-tsv");</script>
      <div style="float:right; bottom:0px;">[
        <a href="javascript:help_popup()">close</a> ]</div>
    </div>
    <div class="pop_content" id="pop_results_xml">
      <script>print_doc("pop_results_xml", "gomo-results-xml");</script>
      <div style="float:right; bottom:0px;">[
        <a href="javascript:help_popup()">close</a> ]</div>
    </div>
    <div class="pop_content" id="pop_motif">
      <script type="text/javascript">print_doc_para('pop_motif', 'motif-id');</script>
    ...
    <div class="pop_content" id="pop_goterm">
      <script type="text/javascript">print_doc_para('pop_goterm', 'gomo-go-term');</script>
      <div class="pop_close">[<a href="javascript:help_popup()">close</a> ]</div>
    </div>
    <div class="pop_content" id="pop_gscore">
      <script type="text/javascript">print_doc_para('pop_gscore', 'gomo-score');</script>
      <div class="pop_close">[<a href="javascript:help_popup()">close</a> ]</div>
    </div>
    <div class="pop_content" id="pop_epvalue">
      <script type="text/javascript">print_doc_para('pop_epvalue', 'gomo-p-value');</script>
      <div class="pop_close">[<a href="javascript:help_popup()">close</a> ]</div>
    </div>
    <div class="pop_content" id="pop_eqvalue">
      <script type="text/javascript">print_doc_para('pop_eqvalue', 'gomo-q-value');</script>
      <div class="pop_close">[<a href="javascript:help_popup()">close</a> ]</div>
    </div>
  ...
  <xsl:template name="top">
    <div class="pad1">
      <div class="prog_logo big">
        <img src="{$gomo_icon.png}" alt="GOMo Logo"/>
        <h1>GOMo</h1>
        <h2>Gene Ontology for Motifs</h2>
      </div>
      <p>
        For further information on how to interpret these results or to get a 
        copy of the MEME software please access <a href="http://meme-suite.org"
          >http://meme-suite.org</a>.<br />
      </p>
    ...
    <div class="pad2">
      ...
      &nbsp;&nbsp;|&nbsp;&nbsp;
      <a class="jump" href="gomo.tsv">Results in TSV Format</a>&nbsp;<span id="results_tsv_help"></span>
      &nbsp;&nbsp;|&nbsp;&nbsp;
      <a class="jump" href="gomo.xml">Results in XML Format</a>&nbsp;<span id="results_xml_help"></span>
      <script>
        make_help_button($("results_tsv_help"), "pop_results_tsv");
  ...
  <xsl:template name="info">
    <div class="bar">
      ...
      <br />
      Command:<br />
      <textarea rows="5" class="cmd" readonly="readonly" >
  ...
  <xsl:template name="explanation">
    ...
    <div class="box">
      ...
      <p>An empirically generated <i>p-value</i>. The null hypothesis is that by shuffling the labels on gene scores, 
        ...
        are generated using the null hypothesis and the number of null hypothesis scores that are better than each of the 
